...
const Profile = () => {
  ...
  const InfoNum = ({ title }) => {
    return (
      ...
      >
        <div>{title} </div>
        <div style={{ fontWeight: "bold", marginLeft: "2px" }}>0</div>
      </div>
    );
  };
  return (
    <div style={{ display: "flex", flex: 1, width: "100vw" }}>
      ...
      >
        <div className="profile-header">
          ...
          <div className="profile-info">
            ...
            <div style={{ display: "flex" }}>
              <InfoNum title="게시물"></InfoNum>
              <InfoNum title="팔로워"></InfoNum>
        ...
        >
          ...
          <div style={{ marginRight: "60px", paddingTop: "14px" }}>
            <svg
              aria-label=""
        ...
        >
          <p style={{ fontWeight: "bold", fontSize: "30px" }}>사진 공유</p>
          <p style={{ fontSize: "16px" }}>
            사진을 공유하면 회원님의 프로필에 표시됩니다.
          </p>
          <p style={{ color: "#0696f6", fontWeight: "bold", fontSize: "16px" }}>
            첫 사진 공유하기
          </p>
        </div>
        <Footer></Footer>
